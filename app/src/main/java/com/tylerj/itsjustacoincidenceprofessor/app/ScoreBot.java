...
import static com.tylerj.itsjustacoincidenceprofessor.algorithm.Algorithm.getPercentageSimilarity;
...
//            }
    ...
    public boolean createCodeObjects(boolean accessGit) throws FileNotFoundException {
        if (!accessGit) {
            File testCodeDir = new File("C:\\Users\\jeffy\\IdeaProjects\\v3\\ItsJustAitsjustacoincidenceprofessor\\TestCode");
